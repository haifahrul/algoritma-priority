...
use app\modules\SmsGatewayMe\models\SmsGatewayMeConfigSearch;
...
class ConfigController extends Controller
{
    ...
    {
        $searchModel = new SmsGatewayMeConfigSearch();
    ...
    public function actionDeleteItems()
    {
        ...
        if (isset($_POST['keys'])) {
            ...
            foreach ($keys as $key):
                ...
                $model = SmsGatewayMeConfig::findOne($key);
                if ($model->delete())
                    $status = 1;
                else
                    $status = 2;
            ...
            //$model = SmsGatewayMeConfig::findOne($keys);
            //$model->delete();
            //$status=3;
        }
        // retrun nya json
    ...
    {
        if (($model = SmsGatewayMeConfig::findOne($id)) !== null) {
            return $model;
        } else {

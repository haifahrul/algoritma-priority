...
/* @var $searchModel app\modules\webmaster\models\search\AttributeSearch */
...
<div class="nav-tabs-custom">
    ...
    <div class="attribute-index">
        ...
        <?= Html::a('<i class="glyphicon glyphicon-plus glyphicon-sm"></i> Create ', ['create'], ['data-pjax' => 0, 'class' => 'btn btn-primary btn-tambah1']) ?>
        <?= Html::button('<span class="glyphicon glyphicon-remove glyphicon-sm"></span> Delete', ['data-pjax' => 0, 'class' => 'btn btn-danger', 'title' => 'hapus', 'id' => 'btn-deletes']) ?>
        </p>
        ...
        <div class="table-responsive">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    'code',
                    [
                        'filter' => ArrayHelper::map(Attribute::find()->groupBy('type')->all(), 'type', 'type'),
                        'attribute' => 'type',
                        'format' => 'raw',
                    ],
                    'position',

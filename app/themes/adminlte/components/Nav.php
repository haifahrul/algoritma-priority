...
//use \yii\base\Widget;
/*Yii::setAlias('themes', dirname(dirname(__DIR__)) . '/backend/themes');
harus  buat alias thmenya
 */
...
class Nav extends Widget
{
    ...
    public function renderItems($items, $options = [])
    {
        ...
        foreach ($items as $item) {
            ...
            if ($icon) {
                $label = '<span class="fa fa-' . $icon . '"></span>' . '<span>' . $label . '</span>';
            ...
            if (empty($item['items'])) {
                ...
                $label .= '<span class="fa fa-angle-left pull-right"></span>';
